 ...
 *  -일반적으로 산술연산자, 복합대입연산자, 비교연산자, 논리 연산자를 많이 사용
 */
...
public class OperatorTest {
	public static void main(String[] args) {
		...
		boolean rs6 = var1 != var2; //var1은 var2보다 보다 서로 다르다.
		...
		boolean res4 =( var3 > 2 ) ||( var4 > 3 ) ; //var3은 4보다 크고 그리고 var4는 5보다 크다.
